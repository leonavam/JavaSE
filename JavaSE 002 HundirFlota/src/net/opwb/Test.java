...
public class Test {
	...
	/*
	 * Método que inicializa el mapa que mostramos al usuario con las tiradas que ha
	...
	/*
	 * Método que inicializa un mapa de juego, colocando los barcos sobre el mismo.
	 */
	...
	/*
	 * Método que nos permite evaluar si un tiro es CORRECTO (AGUA o TOCADO) o se
	...
	/*
	 * Método que actualiza el mapa, con un determinado tiro. Devolvemos el número
	 * de puntos restantes.
	 */
